...
```{r radio.accidents.df4, echo=FALSE, warning=FALSE}
ggplot() +
...
```{r gps.events0, echo=FALSE, warning=FALSE}
...
```{r gps.events1, echo=FALSE, warning=FALSE}
...
```{r biobio.inventary2, echo=FALSE, warning=FALSE}
ggplot() +
  annotation_map_tile(type = "osm", zoom = 15) +
...
```{r biobio.inventary3, echo=FALSE, warning=FALSE}
ggplot() +
  annotation_map_tile(type = "osm", zoom = 15) +
...
```{r biobio.inventary4, echo=FALSE, warning=FALSE}
ggplot() +
  annotation_map_tile(type = "osm", zoom = 15) +
...
```{r biobio.inventary5, echo=FALSE, warning=FALSE}
ggplot() +
...
```{r trafic.alerts2, echo=FALSE, warning=FALSE}
ggplot() +
...
```{r trafic.alerts3, echo=FALSE, warning=FALSE}
ggplot() +
  annotation_map_tile(type = "osm", zoom = 12) +
  stat_density_2d(
...
```{r trafic.alerts4, echo=FALSE, warning=FALSE}
ggplot() +
  annotation_map_tile(type = "osm", zoom = 12) +
  stat_density_2d(
...
```{r trafic.alerts5, echo=FALSE, warning=FALSE}
ggplot() +
  annotation_map_tile(type = "osm", zoom = 12) +
  stat_density_2d(
...
```{r trafic.alerts6, echo=FALSE, warning=FALSE}
ggplot() +
  annotation_map_tile(type = "osm", zoom = 12) +
  stat_density_2d(
...
```{r trafic.alerts7, echo=FALSE, warning=FALSE}
ggplot() +
  annotation_map_tile(type = "osm", zoom = 15) +
  stat_density_2d(
...
```{r trafic.alerts8, echo=FALSE, warning=FALSE}
ggplot() +
  annotation_map_tile(type = "osm", zoom = 15) +
  stat_density_2d(
...
```{r trafic.alerts9, echo=FALSE, warning=FALSE}
ggplot() +
  annotation_map_tile(type = "osm", zoom = 15) +
  stat_density_2d(
...
```{r trafic.alerts10, echo=FALSE, warning=FALSE}
ggplot() +
  annotation_map_tile(type = "osm", zoom = 15) +
  stat_density_2d(
...
```{r trafic.alerts11, echo=FALSE, warning=FALSE}
ggplot() +
  annotation_map_tile(type = "osm", zoom = 15) +
  stat_density_2d(
...
```{r trafic.alerts12, echo=FALSE, warning=FALSE}
ggplot() +
  annotation_map_tile(type = "osm", zoom = 15) +
  stat_density_2d(
...
```{r trafic.alerts13, echo=FALSE, warning=FALSE}
ggplot() +
  annotation_map_tile(type = "osm", zoom = 15) +
  stat_density_2d(
...
```{r trafic.alerts14, echo=FALSE, warning=FALSE}
ggplot() +
  annotation_map_tile(type = "osm", zoom = 15) +
  stat_density_2d(
...
```{r trafic.alerts15, echo=FALSE, warning=FALSE}
ggplot() +
  annotation_map_tile(type = "osm", zoom = 15) +
  stat_density_2d(
...
```{r trafic.alerts16, echo=FALSE, warning=FALSE}
ggplot() +
  annotation_map_tile(type = "osm", zoom = 15) +
  stat_density_2d(
...
```{r trafic.alerts17, echo=FALSE, warning=FALSE}
ggplot() +
  annotation_map_tile(type = "osm", zoom = 15) +
  stat_density_2d(
...
```{r trafic.alerts18, echo=FALSE, warning=FALSE}
ggplot() +
  annotation_map_tile(type = "osm", zoom = 15) +
  stat_density_2d(
...
```{r trafic.alerts19, echo=FALSE, warning=FALSE}
ggplot() +
  annotation_map_tile(type = "osm", zoom = 15) +
  stat_density_2d(
...
```{r trafic.alerts20, echo=FALSE, warning=FALSE}
ggplot() +
  annotation_map_tile(type = "osm", zoom = 15) +
  stat_density_2d(
...
```{r trafic.alerts21, echo=FALSE, warning=FALSE}
ggplot() +
  annotation_map_tile(type = "osm", zoom = 15) +
  stat_density_2d(
...
```{r accidents1, echo=FALSE, warning=FALSE}
ggplot() +
  annotation_map_tile(type = "osm", zoom = 12) +
  stat_density_2d(
...
```{r accidents2, echo=FALSE, warning=FALSE}
ggplot() +
  annotation_map_tile(type = "osm", zoom = 15) +
  stat_density_2d(
...
```{r accidents3, echo=FALSE, warning=FALSE}
ggplot() +
  annotation_map_tile(type = "osm", zoom = 15) +
  stat_density_2d(
...
```{r accidents4, echo=FALSE, warning=FALSE}
ggplot() +
  annotation_map_tile(type = "osm", zoom = 15) +
  stat_density_2d(
...
```{r accidents5, echo=FALSE, warning=FALSE}
ggplot() +
  annotation_map_tile(type = "osm", zoom = 15) +
  stat_density_2d(
