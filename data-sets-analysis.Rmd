...
library(tidyxl)
library(viridis)
load("~/GitHub/data-sets-analysis/.RData")
```
...
```{r interurban.bus.accidents0, echo=FALSE}
...
```{r interurban.bus.accidents1, echo=FALSE}
ggplot(interurban.bus.accidents) +
...
```{r interurban.bus.accidents2, echo=FALSE}
ggplot(interurban.bus.accidents) +
...
```{r interurban.bus.accidents3, echo=FALSE}
ggplot(interurban.bus.accidents) +
...
```{r interurban.bus.accidents4, echo=FALSE}
n <- 10
...
```{r gh0269290, echo=FALSE}
ggplot(gh026929) +
  geom_density(aes(x = `GPS (2D speed) [m/s]`))
```


```{r police.accidents0, echo=FALSE}
...
```{r police.accidents1, echo=FALSE}
ggplot(police.accidents) +
...
```{r police.accidents2, echo=FALSE}
n <- 10
...
```{r police.accidents3, echo=FALSE}
ggplot(police.accidents) +
...
```{r police.accidents4, echo=FALSE}
...
```{r police.accidents5, echo=FALSE}
ggplot(police.accidents) +
...
```{r radio.accidents.df0, echo=FALSE}
...
```{r radio.accidents.df1, echo=FALSE}
...
```{r radio.accidents.df2, echo=FALSE}
ggplot(radio.accidents.df) +
...
```{r chiguayante.speed.df2, echo=FALSE}
ggplot(chiguayante.speed.df) +
...
```{r chiguayante.speed.df3, echo=FALSE}
ggplot(chiguayante.speed.df) +
  geom_density(aes(x = `Velocidad [km/hr]`, colour = dirección))
```


```{r chiguayante.speed.df4, echo=FALSE}
ggplot(chiguayante.speed.df) +
...
```{r chiguayante.speed.df5, echo=FALSE}
ggplot(chiguayante.speed.df) +
...
```{r chiguayante.speed.df6, echo=FALSE}
ggplot(chiguayante.speed.df) +
...
ggplot(waze.data[waze.data$Street %in% top,]) +
  geom_bar(aes(
    ...
    fct_rev(),
    fill = City)) +
  labs(title = "Calles de las alertas de Waze", y = "Street")
```


```{r waze.data1, echo=FALSE}
ggplot(waze.data) +
  geom_bar(aes(
    y = City %>%
    fct_infreq() %>%
    fct_rev(),
    fill = Cause)) +
  labs(title = "Causas de las alertas de Waze", y = "City")
```


```{r waze.data2, echo=FALSE}
ggplot(waze.data) +
