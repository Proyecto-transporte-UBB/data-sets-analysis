...
- Se crea la columna "EVT_SEÑAL" a partir de los valores de la columna "EVT_GPS_DOP":
  - `Excelente`: $\text{EVT_GPS_DOP} < 1$
  - `Muy Buena`: $1 \leq \text{EVT_GPS_DOP} < 2$
  - `Buena`: $2 \leq \text{EVT_GPS_DOP} < 5$
  - `Regular`: $5 \leq \text{EVT_GPS_DOP} \leq 10$
  - `Mala`: $\text{EVT_GPS_DOP} > 10$
...
- **Diferencia promedio**: 5 minutos, 33 segundos
