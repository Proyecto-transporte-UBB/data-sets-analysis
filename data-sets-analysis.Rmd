...
gh026929 %>% ggplot() +
  ...
  labs(title = "Frecuencia por minuto")
```
...
- Diferencia Máxima: 2241756 segundos
- Diferencia Media: 411 segundos
- Diferencia Mediana: 61 segundos
- Desviación Standard: $5.42\times10^{-4}$ segundos
...
tracking.gps.df %>% ggplot() +
  geom_density(aes(x = differences, colour = EVT_CARPETA)) +
...
tracking.gps.df[tracking.gps.df$EVT_SERVICIO_ID %in% (tracking.gps.df %>%
  ...
  labs(y = "Ruta", fill = NA, title = "10 rutas más frecuentes")
```
