...
```{r pre.load, eval=FALSE, include=FALSE}
key.objects <- c("interurban.bus.accidents", "gh026929", "tracking.gps.df", "police.accidents", "radio.accidents.df", "chiguayante.speed.df", "vega.speed.df", "gps.events", "biobio.inventary", "trafic.alerts", "accidents", "waze.data", "meters.per.degree.lat", "meters.per.degree.lng", "quantum.data")
...
load("~/GitHub/data-sets-analysis/.RData", verbose = T)
```
